...
export async function advanceVectorDigest({
  ...
  feePayer?: Address
  postInstructions: readonly Instruction[]
  ...
  return createVectorDigest({
    ...
    seed,
    signerAddress,
    targetIndex: preInstructions.length,
    vectorInstruction: advanceInstruction,
  })
}

export async function closeVectorDigest({
  closeTo,
  feePayer,
  postInstructions,
  preInstructions,
...
export async function createAdvanceInstruction({
  programAddress,
  signerAddress,
  subInstructions,
  vectorSignature,
...
export async function signAdvanceInstruction({
  feePayer,
  postInstructions,
  preInstructions,
  programAddress,
...
export async function signCloseInstruction({
  closeTo,
  feePayer,
  postInstructions,
  preInstructions,
...
async function createVectorDigest({
  ...
  const instructions = promoteToMessageFlags({
    feePayer,
    instructions: [...preInstructions, vectorInstruction, ...postInstructions].map(resolveInstruction),
  })
